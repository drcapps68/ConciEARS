				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">Country Bear Jamboree Information</h4>
						</div>
						<div class="modal-body">
							<h5><strong>Riders per vehicle:</strong> not applicable, seated attraction</h5>
							<h5><strong>Restrictions:</strong> No age or height restriction</h5>
				...
				<div id="ppRideCounterModal" class="modal fade" role="dialog">
						<div class="modal-dialog">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
										<h3>Do you want to add Country Bear Jamboree to your ride count?</h3>
										<div>
										<!--	Yes Button-->
